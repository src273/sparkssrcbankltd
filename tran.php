<?php 
            ...
            $sqls = "SELECT * FROM `bank` WHERE name='$names' " ;
            $results = mysqli_query($con, $sqls);
            $sqlr = "SELECT * FROM `bank` WHERE name='$namer' " ;
            $resultr = mysqli_query($con, $sqlr);
            $sql = "INSERT INTO `history` (`sender`, `receiver`, `money`, `date`) 
            ...
            $ups = "UPDATE `bank` SET balance='$vals' WHERE name= '$names'";
            $upr = "UPDATE `bank` SET balance='$valr' WHERE name= '$namer'";
